<template>
  <v-app dark>
    ...
    <!--                        <div>{{ mob.level }}</div>-->
    <!--                      </v-flex>-->
    <!--                      &lt;!&ndash;                      <v-flex xs8 md4 v-for="(item, index) in items" :key="index">&ndash;&gt;-->
    <!--                      &lt;!&ndash;                        <v-img&ndash;&gt;-->
    <!--                      &lt;!&ndash;                          :src=item.image&ndash;&gt;-->
    <!--                      &lt;!&ndash;                          :lazy-src=item.lazy_image&ndash;&gt;-->
    <!--                      &lt;!&ndash;                          max-height="40px"&ndash;&gt;-->
    <!--                      &lt;!&ndash;                          max-width="40px"&ndash;&gt;-->
    <!--                      &lt;!&ndash;                          @mouseover=hoverItem(item)&ndash;&gt;-->
    <!--                      &lt;!&ndash;                        >&ndash;&gt;-->
    <!--                      &lt;!&ndash;                        </v-img>&ndash;&gt;-->
    <!--                      &lt;!&ndash;                      </v-flex>&ndash;&gt;-->
    <!--                    </v-layout>-->
